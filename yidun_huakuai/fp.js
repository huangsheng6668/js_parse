...
! function() {
    ...
    function W() {
        ...
        h && (n[l[6]] = h),
            h = null,
            n[u[61]] = _host; // 这个G为域名，需要修改
        var p = new Date().getTime() + de // p为时间戳 + de，de为一个定值，可以不用改写，不用管
            ,
            _ = p + t[302] * t[142] * t[142] * t[68] * t[297] * t[20];
        n[u[86]] = $(t[13]) + p + $(t[13]); // 随机三位英文或数字 + 时间戳 + 随机三位英文或数字
        try {
            var T = [29634074234040, 9136619895761];
