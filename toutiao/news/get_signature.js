...
const app = require('./get_as_and_cp');
...
function p(t, e) {
    ...
    var s = window.byted_acrawler.sign(a);
    return s
}

function get_signature() {
    let as_cp_obj = app.get_as_and_cp();
    let {as} = as_cp_obj;
    let {cp} = as_cp_obj;
    // let as = "A115FF71BB1FB26";
    // let cp = "5F1B8F8BA256BE1";
    ...
    let o = (0,
        p)("/toutiao/api/pc/feed/?max_behot_time="+timestemp, sig_obj);
    console.log(o);
}
get_signature();
