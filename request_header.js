...
location.host = "bitstamp.net";
location.hostname = "bitstamp.net";
location.href = "https://www.bitstamp.net/news/";
location.origin = "https://www.bitstamp.net";
...
window.dodument = document;
var XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest;
window.XMLHttpRequest = XMLHttpRequest;
// atob = function (str) {
//     let temp = new Buffer(str , 'base64').toString();
//     return temp;
// }
//
// btoa = function (str) {
